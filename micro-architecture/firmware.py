...
firmware.set_instruction(0, 0b000000000_100_00000000_00000000_000_000_001)
# HALT
...
firmware.set_instruction(2, 0b000000011_000_00010100_10000000_000_010_010)

# 3: X1 <- MDR + X1; goto MBR1
firmware.set_instruction(3, 0b000000000_100_00111100_00010000_001_100_001)

# X1 = X1 - memory[address]

# 2: MAR <- MBR1; MDR <- read_word(MAR); goto 4
firmware.set_instruction(4, 0b000000101_000_00010100_10000000_000_010_010)

# 3: X1 <- X1 - MDR; goto MBR1
firmware.set_instruction(5, 0b000000000_100_00111111_00010000_001_100_001)

# memory[address] = X1

# MAR <- MBR1; goto 7
firmware.set_instruction(6, 0b000000111_000_00010100_10000000_000_010_000)

# MDR <- X1; write; goto MBR1
firmware.set_instruction(7, 0b000000000_100_00010100_01000000_000_100_100)
...
## 14: PC <- MBR1; fetch; goto MBR1
firmware.set_instruction(8, 0b000000000_100_00010100_00100000_000_010_001)
